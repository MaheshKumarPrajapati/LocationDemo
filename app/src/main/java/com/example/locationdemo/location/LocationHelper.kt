...
open class LocationHelper(private val activity: Activity) :
    LifecycleObserver {
   ...
   // var currentLocation = MutableLiveData<Pair<Double?, Double?>>()
     ...
     */
    public fun checkLocationSettings() {
    ...
    private val locationCallback: LocationCallback = object : LocationCallback() {
        ...
        override fun onLocationResult(locationResult: LocationResult?) {
            ...
            currentLocation.value = if(locationResult?.locations!=null){locationResult?.locations.get(0)}else{
               null
            }
        }
    }
